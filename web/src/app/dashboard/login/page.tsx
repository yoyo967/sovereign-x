...
// ═══════════════════════════════════════════════════════════════
// SOVEREIGN 2030 — Login Page
// Blueprint Dark Design · Firebase Auth (Email + Google)
// ═══════════════════════════════════════════════════════════════
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          <Link href="/de" style={{ textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 10 }}>
            <div style={{
              width: 32, height: 32, border: "1.5px solid rgba(0,212,255,0.4)",
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            {error && (
              <div style={{
                ...
                color: "rgba(255,80,80,0.9)", lineHeight: 1.5,
              }}>
                {error}
              </div>
            )}
        ...
        <div style={{
          ...
          <p style={{ fontFamily: "var(--font-mono, monospace)", fontSize: "0.58rem", color: "rgba(255,255,255,0.2)", lineHeight: 1.6 }}>
